...
PYBIND11_MODULE(pyTORS, m) {
	...
	py::class_<Track>(m, "Track")
		...
		.def_property_readonly("a_side_tracks", &Track::GetASideTracks, py::return_value_policy::reference)
		.def_property_readonly("b_side_tracks", &Track::GetBSideTracks, py::return_value_policy::reference)
		.def("get_opposite_side", &Track::GetOppositeSide, py::arg("track"), py::return_value_policy::reference)
		.def("is_a_side", &Track::IsASide, py::arg("track"))
		.def("is_b_side", &Track::IsBSide, py::arg("track"))
		.def("is_same_side", &Track::IsSameSide, py::arg("track_1"), py::arg("track_2"))
		.def("is_neighbor", &Track::IsNeighbor, py::arg("track"))
